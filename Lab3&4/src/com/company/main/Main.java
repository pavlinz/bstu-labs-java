    ...
    public static void main(String[] args) {
        ...
        if (authorization.clientFlag) {
            ...
            while(choice != 0) {
                ...
                switch(choice) {
                    case 1: authorization.client.showBalance(); break;
                    case 2: authorization.client.replenishAccount(); break;
                    case 3: authorization.client.blockCard(); break;
                    case 4: authorization.client.makePayment(); break;
                }
            }
        }
            ...
            while(choice != 0) {
                ...
                switch(choice) {
                    case 1: authorization.admin.blockCard(); break;
                    case 2: authorization.admin.unlockCard(); break;
                }
            }
        }
    }
